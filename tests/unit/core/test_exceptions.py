...
class TestHttpStatusCodes:
    ...
    @pytest.mark.parametrize("exc_class,expected_status", [
        ...
        (InvalidTransformError, status.HTTP_422_UNPROCESSABLE_ENTITY),
        (InvalidOcclusalConstraintError, status.HTTP_422_UNPROCESSABLE_ENTITY),
        (DicomError, status.HTTP_422_UNPROCESSABLE_ENTITY),
        (DicomParseError, status.HTTP_422_UNPROCESSABLE_ENTITY),
        (DicomValidationError, status.HTTP_422_UNPROCESSABLE_ENTITY),
        (EmptyMaskError, status.HTTP_422_UNPROCESSABLE_ENTITY),
        (InsufficientOverlapError, status.HTTP_422_UNPROCESSABLE_ENTITY),
        (ReductionConstraintViolation, status.HTTP_422_UNPROCESSABLE_ENTITY),
        (SymmetryThresholdError, status.HTTP_422_UNPROCESSABLE_ENTITY),
        (LowConfidenceSegmentationError, status.HTTP_422_UNPROCESSABLE_ENTITY),
        # 409 Conflict
