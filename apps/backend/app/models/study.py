...
class ImagingStudy(Base):
    ...
    volume_path: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    slice_thickness_mm: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    pixel_spacing_mm: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    kv_peak: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
